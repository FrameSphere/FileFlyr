/**
 * JPG to PNG Converter Module
 */

let selectedFiles = [];

export async function init() {
    console.log('🖼️ JPG to PNG converter initialized');
    ...
    optionsContent.innerHTML = `
        <div class="option">
            ...
            <select id="resize">
                ...
                <option value="150">150% Larger</option>
            </select>
        </div>
    `;
    ...
    convertBtn.addEventListener('click', async function() {
        ...
        for (let i = 0; i < selectedFiles.length; i++) {
            ...
            try {
                const blob = await convertJPGtoPNG(file, resizeValue);
    ...
    async function convertJPGtoPNG(file, resizeValue) {
