...
export async function init() {
    ...
    optionsContent.innerHTML = `
        <div class="option">
            ...
            <input type="number" id="width" value="1024" min="1" max="10000">
        </div>
        <div class="option">
            <label for="height">Height (px)</label>
            <input type="number" id="height" value="1024" min="1" max="10000">
        </div>
        <div class="option">
            <label>
    ...
    convertBtn.addEventListener('click', async function() {
        ...
        for (let i = 0; i < selectedFiles.length; i++) {
            ...
            try {
                const blob = await convertSVGtoPNG(file, width, height, keepAspect, bgColor);
    ...
    async function convertSVGtoPNG(file, width, height, keepAspect, bgColor) {
