...
function generateHTML(slug, cfg, content) {
  const url     = `https://fileflyr.pages.dev/convert/${slug}/`;
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":2,"name":"Converters","item":"https://fileflyr.pages.dev/#converters"},
...
<head>
    ...
    <meta property="og:image" content="https://fileflyr.pages.dev/assets/og-image.png">
    ...
    <meta name="twitter:image" content="https://fileflyr.pages.dev/assets/twitter-image.png">
